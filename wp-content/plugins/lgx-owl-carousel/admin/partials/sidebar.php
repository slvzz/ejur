...
<div id="postbox-container-1" class="postbox-container">
    <div class="meta-box-sortables">
        ...
        <div class="postbox">
            <h3>Help & Supports</h3>
            <div class="inside">
                <p>Support : <a class="button" href="https://logichunt.com/support/" target="_blank">Support</a></p>
                <p>Contact : <a class="button " href="https://logichunt.com/contact-us" target="_blank">Contact</a></p>
                <p>website : <a class="button" href="https://logichunt.com/contact-us" target="_blank">Website</a></p>
        ...
        <div class="postbox">
            ...
            <div class="inside">
                ...
                if (function_exists('fetch_feed')) {
                    $feed = fetch_feed('https://logichunt.com/feed?post_type=product');
                    ...
                    if (!is_wp_error($feed)) : $feed->init();
                        ...
                        foreach ($blocks as $block) {
                            ...
                            //echo '<img style="float: left; display: inline; width:70px; height:70px; margin-right:10px;" src="https://logichunt.com/wp-content/uploads/productshots/'.$id.'-profile.png" alt="logichuntplugins" />';
